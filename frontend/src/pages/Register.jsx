...
import { Sparkles, User as UserIcon, Mail, Lock, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center bg-grid-pattern relative px-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-lg font-bold text-slate-300 font-display mt-6">Create Account</h2>
          <p className="text-xs text-slate-500 mt-1">Get $100,000 virtual cash instantly to start paper trading</p>
        </div>
                  ...
                  {AVATAR_SEEDS.map((seed) => (
                    <button
                      ...
                      className={`w-8.5 h-8.5 rounded-full overflow-hidden border-2 transition-all shrink-0 ${
                        avatarSeed === seed ? 'border-indigo-500 scale-105' : 'border-slate-800 opacity-60 hover:opacity-100'
                      }`}
                    >
                      <img
